...
const DeleteNews = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const news = yield newsSchema_1.default.findOne({ _id: newsId });
    if (!news)
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Check is news available!');
    // deleting data
    yield newsSchema_1.default.deleteOne({ _id: newsId });

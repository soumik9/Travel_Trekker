...
exports.hotelSearchableFields = exports.hotelFilterableFields = void 0;
...
exports.hotelFilterableFields = ['searchTerm', 'name', 'location'];
exports.hotelSearchableFields = ['email'];
const getHotels = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const andConditions = [];
    const filters = (0, pick_1.default)(req.query, exports.hotelFilterableFields);
    ...
    if (searchTerm) {
        andConditions.push({
            $or: exports.hotelSearchableFields.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
    ...
    // get books
    const result = yield hotelSchema_1.default.find(whereConditions).sort(sortConditions).select({ __v: 0 });
    const totalRecords = yield hotelSchema_1.default.countDocuments();

...
const createHotel = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingHotel = yield hotelSchema_1.default.findOne({ name: req.body.name });
    if (existingHotel) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'An hotel with this name already exists.');
    }
    yield hotelSchema_1.default.create(req.body);

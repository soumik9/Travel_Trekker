...
exports.userFilterableFields = ['searchTerm', 'email', 'address.city', 'role.name'];
exports.userSearchableFields = ['email'];
const getUsers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const andConditions = [];
    const filters = (0, pick_1.default)(req.query, exports.userFilterableFields);
    ...
    if (searchTerm) {
        andConditions.push({
            $or: exports.userSearchableFields.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
    ...
    // get books
    const result = yield userSchema_1.default.find(whereConditions).sort(sortConditions).select({ __v: 0 });

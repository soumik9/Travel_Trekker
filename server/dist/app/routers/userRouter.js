...
router.get('/:userId', (0, auth_1.default)(constants_1.ENUM_USER_ROLE.SUPER_ADMIN, constants_1.ENUM_USER_ROLE.ADMIN, constants_1.ENUM_USER_ROLE.USER), getUser_1.default);
router.patch('/authenticated-id', (0, validateRequest_1.default)(authValication_1.AuthValidation.updateUserZodSchema), (0, auth_1.default)(constants_1.ENUM_USER_ROLE.SUPER_ADMIN, constants_1.ENUM_USER_ROLE.ADMIN, constants_1.ENUM_USER_ROLE.USER), updateUserByAuthId_1.default);
router.patch('/:userId', (0, validateRequest_1.default)(authValication_1.AuthValidation.updateUserZodSchema), (0, auth_1.default)(constants_1.ENUM_USER_ROLE.SUPER_ADMIN, constants_1.ENUM_USER_ROLE.ADMIN), updateUser_1.default);

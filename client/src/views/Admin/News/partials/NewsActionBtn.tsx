...
import { useDeleteNewsMutation } from '@/redux-rtk/features/news/newsApi';
    ...
    return (
        <div className='flex gap-[7px]'>
            ...
            <button
                ...
                onClick={() => sendDeleteRequest(row._id, deleteNews)}
            >
